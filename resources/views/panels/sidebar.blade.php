      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item has-sub">
              ...
              <ul class="menu-content">
                  ...
                  <li>
                      <a href="{{ route('tests.index') }}" class="d-flex align-items-center" target="_self">
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>
                          <span class="menu-item text-truncate">Tests</span>
                      </a>
                  </li>
              </ul>
          </li>
          ...
          @hasrole('manager')
          <li class="nav-item">
              <a href="{{ route('manager.index') }}" class="d-flex align-items-center" target="_self">
                  <span class="menu-title text-truncate">Tests</span>
              </a>
          </li>
          @endhasrole
      </ul>
